...
\end{center}
Plot of how $\gamma$ varies as different study design parameters change
\end{frame}
...
\item Special thanks to Professor Karl Broman for the {\LaTeX} Template for these slides
\end{itemize}
\end{frame}
